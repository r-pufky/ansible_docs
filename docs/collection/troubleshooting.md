...
!!! tip "**--ask-become-pass** will be needed if sudo used or use GPG key injection."
...
```
!!! warning "An ignore file is required for each specific **version** of ansible."

!!! tip
    **Order Matters**: if ignores are throwing warnings, check ordering and
    make sure they are ordered correctly. Proper ignores will **not** generate
    warnings.
...
[^4]: https://ansible.readthedocs.io/projects/lint/rules/sanity/
